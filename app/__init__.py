...
def create_app(config_name):
  ...
  app.add_url_rule('/api/v2/parties', view_func=create_party_view, methods=['POST'])
  app.add_url_rule('/api/v2/parties/<int:party_id>', view_func=fetch_party_view, methods=['GET'])
  app.add_url_rule('/api/v2/parties', view_func=fetch_all_parties_view, methods=['GET'])
  app.add_url_rule('/api/v2/parties/<int:party_id>/name', view_func=update_party_view, methods=['PATCH'])
  app.add_url_rule('/api/v2/parties/<int:party_id>', view_func=delete_party_view, methods=['DELETE'])
  app.add_url_rule('/api/v2/offices', view_func=create_office_view, methods=['POST'])
